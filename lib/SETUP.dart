...
class _setupState extends State<setup> {
  ...
  Future<void> save() async {
    ...
    if (location.text!=""&& postcode.text!=""
      ...
      FirebaseFirestore.instance.collection("buyers").doc(meter.text).set({
        "location" : location.text,
        "postcode" : postcode.text,
        "username" : username.text,
        "email" : email.text,
        "gps":"${lt.toStringAsFixed(4)}, ${lg.toStringAsFixed(4)}",
        "mobile": mobile.text,
        "meterid":meter.text,
        "username_exist":"true",
    ...
    setState(() {
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) {
        Navigator.of(context).pushAndRemoveUntil(
            MaterialPageRoute(builder: (BuildContext context) => home()),(route) => false);
